...
#1. Verificacion de numero positivo o negativo
...
#4. Verificar si está entre 10 y 20
...
#5. Encuentrar el mayor de los tres numeros usando condicionales.
...
#6. Precio final con un 10% de descuento si el total es mayor a $100.
...
#7. Verificar si una persona puede votar (mayor o igual a 18 años).
...
#9. Determinar si un número es múltiplo de 5 y de 3 al mismo tiempo.
...
#10. Verificar si es divisible entre dos números dados.
...
#11. Crear lista y si el tercer número es mayor que 10, muestra “Mayor a 10”, si no, muestra “Menor o igual a 10”.
# lista1 = [1, 3, 4, 7]
# num=int(input("Ingresa un numero para completar la lista: "))
# if num > 10:
#     print("Mayor a 10")
# else:
#     print("Menor o igual a 10")

#12. Verificar si el número 7 está en la lista [3, 5, 7, 9]. Si está, muestra “Está en la lista”, si no, muestra “No está en la lista”
# lista2=[3, 5, 7, 9]
# numero=int(input("Ingresa el numero que creas para adivinar")) 
# if numero==7:
#     print("Adivinaste! el numero si está en la lista: " ,lista2 )
# else:
#     print("No está en la lista")

#13. Sumar los dos primeros elementos de la lista [4, 6, 2, 8]. Si la suma es mayor que 10, muestra “Suma alta”, de lo contrario, muestra “Suma baja”.
# lista3= [4, 6, 2, 8]
...
#15. Crear una lista con tres colores. Cambia el segundo color solo si es igual a "azul", y muestra la lista actualizada.
...
#16. Crear una tupla con los valores (5, 8, 12, 20). Si el primer valor es menor que el último, muestra “Orden ascendente”, si no, “Orden descendente”.
# tupla1=(5, 8, 12, 20)
...
#17. Verificar si el segundo valor es mayor a 30. Si lo es, muestra “Edad mayor a 30”, si no, “Edad menor o igual a 30” de la siguiente tupla: (25, 32, 28)".
# tupla2=(25, 32, 28)
# if tupla2[1] >30:
...
#18. Convertir la tupla (1, 2, 3) a lista, cambiar el segundo valor a 10 solo si es igual a 2, luego vuelve a convertirla en tupla y muéstrala.
# tupla3=(1, 2, 3)
# print("Tupla: " ,tupla3)
# lista = list(tupla3)
# if lista[1] == 2:
...
#20. Comparar si las tuplas (3, 4) y (3, 5) son iguales. Si lo son, muestra “Tuplas iguales”, si no, “Tuplas diferentes”.
# tup1=(3, 4)
# tup2=(3, 5)
# if tup1==tup2:
...
#21. Crear un diccionario con {"nombre": "Juan", "edad": 17}. Si la edad es mayor o igual a 18, muestra “Adulto”, si no, muestra “Menor de edad”
# diccionario1={
#     "Nombre":"Juan",
#     "Edad":17 }
